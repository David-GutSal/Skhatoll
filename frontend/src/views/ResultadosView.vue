...
const imagenCelebracion = computed(() => {
  ...
  return bandoGanador.value?.toLowerCase() === 'lobo' ? loboscelebrandoImg : aldeanoscelebrandoImg
})
...
.fondo-victoria {
  background-image: url('@/assets/imgs/fondovictoria.webp');
}
.fondo-derrota {
...
.fondo-enamorados {
  background-image: url('@/assets/imgs/fondoenamorado.webp');
}
...
.imagen-derrota {
  ...
  border-bottom: 5px solid var(--color-rojo);
}
.imagen-empate {
